...
以更新时间从新到旧排序。
### 正文
v21.4.0.165_x86_20260516<br>
修订简体中文语言文件；更新 Corel Setup Engine 修改。

v21.4.0.170_x64_20260515<br>
安装程序结构重构；修订简体中文语言文件；修改程序语言菜单排序；更新 Corel Setup Engine 修改。

----------------------- 版本号规则修改分割线 -----------------------

从 v21.4.0.170_x64_20260515 版本开始，我们修改了特别版程序的版本号规则。<br>
新的修订版本号由原程序版本号 + 程序架构 + 制作日期 + 当日修订次数<br>
（仅当在同一天内发布上一个版本修复版本时适用）组成。<br>
