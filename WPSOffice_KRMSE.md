...
### 正文
v10.8.2.7164_20260806、v10.8.2.7119_20260806、v11.8.2.11023_20260806、v11.8.2.12265_20260806、v11.8.2.12344_20260806
- 修复静默安装失效问题；
- 2019 版本集成 PDF 组件序列号，现在在勾选“PDF 高级功能”并且可以访问互联网时，可以直接在线激活 PDF 组件。

v10.8.2.7164_20260803、v10.8.2.7119_20260803、v11.8.2.11023_20260805、v11.8.2.12265_20260803、v11.8.2.12344_20260803
- 修复特定系统环境下，由于用户文件夹带空格造成安装体验无法正常配置程序定制参数的问题；
- 修复 2019 版本 PDF 转 Word 插件每次转换都要加载较长时间的问题；
- 更换程序序列号；
- 移除控制面板→卸载程序中程序显示名称中的“雨糖科技特别版”字样；
- 进一步屏蔽程序信息收集。

v11.8.2.11023_20260702、v11.8.2.12265_20260702、v11.8.2.12344_20260703
- 11.8.2.11023 版本编译时间比 11.8.6.11021 要更新，是已知支持 Windows XP 和 Vista 的最新版本，因此制作本版本修订更新替代上述版本；
- 针对近期网络上「WPS 偷偷占满 C 盘」的吐槽声，新增「将当前用户的部分程序数据转移至我的文档」可选实验安装项；
- 新增「移除轻办公外壳扩展（右键菜单中的上传或同步、通过 WPS 发送等）」可选安装项；
- 新增 Windows Server 2008 R2 安装支持（实验功能）；
- 增强 11.8.2.12344 版本安装程序方面的稳定性。

v11.8.2.12344_20260422<br>
- 「私有化版本功能解锁补丁」可选实验安装项已经正式可用，在安装程序中与 PDF 编辑功能一齐勾选后，即可解锁上述功能；
- 新增「移除轻办公外壳扩展（右键菜单中的上传或同步、通过 WPS 发送等）」可选安装项；
- 修复安装程序没有执行 VBA 运行库安装的问题。

v11.8.2.12265_20260313<br>
- 将“安装在线版本时解锁应用中心隐藏功能”特性拆分为可选实验安装项；
- 补充公文组件的缺失字体；
- 新增内测功能；
- 进一步完善程序配置。
...
v10.8.2.7164_20260305<br>
新增闪屏图片 Logo 自定义功能，将 PNG 格式的 Logo 图片重命名为“NijikaWPSCustomLogo.png”，复制到安装程序所在目录即可。

v10.8.2.7119_20260305<br>
新增闪屏图片 Logo 自定义功能，将 PNG 格式的 Logo 图片重命名为“NijikaWPSCustomLogo.png”，复制到安装程序所在目录即可；更换底包为正确的版本。
...
v11.8.2.12265_20251220<br>
移除云服务选项卡中的「稻壳商城」按钮（因为现在会提示必须更新程序才能使用）；移除开始菜单程序组中的雨糖科技特别版字样；添加微软 Access 数据库引擎可选功能（用于邮件合并功能）；新增集成 WPS Security SDK DLL 文件。

v11.8.2.12330_20251125<br>
跟进官方最新版本更新；移除云服务选项卡中的「稻壳商城」按钮（因为现在会提示必须更新程序才能使用）；移除开始菜单程序组中的雨糖科技特别版字样。

v11.8.6.11021_20251125<br>
移除云服务选项卡中的「稻壳商城」按钮（因为现在会提示必须更新程序才能使用）；移除开始菜单程序组中的雨糖科技特别版字样。

----------------------- 版本号规则修改分割线 -----------------------

从 v11.8.2.12330_20251125 版本开始，我们修改了特别版程序的版本号规则。新的修订版本号由原程序版本号 + 制作日期 + 当日修订次数（仅当在同一天内发布上一个版本修复版本时适用）组成。

----------------------- 版本号规则修改分割线 -----------------------

v11.8.2.12309_r007 (2024/11/27，纪念更新)<br>
新增闪屏图片 Logo 自定义功能，将 PNG 格式的 Logo 图片重命名为“NijikaWPSCustomLogo.png”，复制到安装程序所在目录即可；新增“移除程序启动时的闪屏图片”实验功能；完善程序定制配置；应用中心新增“思维导图”与“流程图”功能入口；修复离线版本中自带离线模板不显示的问题。

v11.8.2.12265_r017 (2024/11/27，纪念更新)<br>
进一步完善离线版本程序配置，修复离线版本中自带离线模板不显示的问题。

v11.8.6.11021_r012 (2024/11/27，纪念更新)<br>
进一步完善离线版本程序配置，修复离线版本中自带离线模板不显示的问题。

v10.8.2.7164_r003 (2024/11/27，纪念更新)<br>
现在安装离线版本时，安装体验会移除云办公组件，以去除文件菜单中的登录提示入口；移除经典模式下工具栏中的稻壳素材按钮（由于已不可用）。

v11.8.2.12265_r016 (2024/11/13)<br>
新增闪屏图片 Logo 自定义功能，将 PNG 格式的 Logo 图片重命名为“NijikaWPSCustomLogo.png”，复制到安装程序所在目录即可；新增“移除程序启动时的闪屏图片”实验功能；完善程序定制配置。

v11.8.6.11021_r011 (2024/11/13)<br>
新增闪屏图片 Logo 自定义功能，将 PNG 格式的 Logo 图片重命名为“NijikaWPSCustomLogo.png”，复制到安装程序所在目录即可；新增“移除程序启动时的闪屏图片”实验功能；更新国产化版本 Ink Draw DLL 文件；完善程序定制配置。
...
v11.8.2.12309_r005 (2024/09/27)<br>
增强静默安装支持，现在可以使用 /DIR=<路径> 命令行参数指定程序安装路径了；去除开始菜单程序组中的雨科特别版字样；对程序配置定制文件进行进一步的完善；对安装体验与程序安装目录空间占用进行进一步优化处理。

v11.8.2.12265_r015、v11.8.6.11021_r010 (2024/09/27)<br>
现在，卸载过程现在会主动询问是否卸载 VBA 组件；增强静默安装支持，现在可以使用 /DIR=<路径> 命令行参数指定程序安装路径了；去除开始菜单程序组中的雨科特别版字样；对程序配置定制文件进行进一步的完善；对安装体验与程序安装目录空间占用进行进一步优化处理。

v11.8.2.12309_r003 (2024/09/24)<br>
现在，VBA 组件和公文相关方正字体已经重新成为可选功能了，您可以选择性不安装它们；卸载过程现在会主动询问是否卸载 VBA 组件；增强静默安装支持，现在可以使用 /DIR=<路径> 指定程序安装路径了。
...
v11.8.2.12265_r011、v11.8.6.11021_r007 (2024/09/10)<br>
