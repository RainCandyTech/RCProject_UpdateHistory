...
增强静默安装支持，现在可以使用 /DIR=<路径> 命令行参数指定程序安装路径了；去除开始菜单程序组中的雨科特别版字样；对程序配置定制文件进行进一步的完善；更换程序使用的序列号；对安装体验与程序安装目录空间占用进行进一步优化处理。

v11.8.2.12265_r015、v11.8.6.11021_r010 (2024/09/27)<br>
现在，卸载过程现在会主动询问是否卸载 VBA 组件；增强静默安装支持，现在可以使用 /DIR=<路径> 命令行参数指定程序安装路径了；去除开始菜单程序组中的雨科特别版字样；对程序配置定制文件进行进一步的完善；更换程序使用的序列号；对安装体验与程序安装目录空间占用进行进一步优化处理。
